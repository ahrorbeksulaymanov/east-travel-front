            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-12">
                    <div className="xl:col-span-5 lg:col-span-6 col-span-12">
                        ...
                        <p className="font-normal text-[#697687] mt-[10px] mb-[15px]">how travel can be one of the best tools for personal growth. We share some of the life lessons we've learned on the road that has provided us insight into empathy, mindfulness, meditation, comfort zones, two-way storytelling, being present, connection and more.</p>
                        <div className="grid grid-cols-12 gap-x-[13px] gap-y-[26px] w-max mt-[22px] md:mx-0 mx-auto">
                            <div className="col-span-6">
                                <div className='rounded-[10px] py-[32px] w-[150px] text-center' style={{border: "2px solid #F8F8F8"}}>
                                    <h3 className='text-main-color text-[32px] font-medium'>10M+</h3>
                                    <p className='text-second-color text-[16px] font-semibold'>Vissitors</p>
                                </div>
                            </div>
                            <div className="col-span-6">
                                <div className='rounded-[10px] py-[32px] w-[150px] text-center' style={{border: "2px solid #F8F8F8"}}>
                                    <h3 className='text-main-color text-[32px] font-medium'>109</h3>
                                    <p className='text-second-color text-[16px] font-semibold'>Hotels</p>
                                </div>
                            </div>
                            <div className="col-span-6">
                                <div className='rounded-[10px] py-[32px] w-[150px] text-center' style={{border: "2px solid #F8F8F8"}}>
                                    <h3 className='text-main-color text-[32px] font-medium'>29</h3>
                                    <p className='text-second-color text-[16px] font-semibold'>Food shops</p>
                                </div>
                            </div>
                            <div className="col-span-6">
                                <div className='rounded-[10px] py-[32px] w-[150px] text-center' style={{border: "2px solid #F8F8F8"}}>
                                    <h3 className='text-main-color text-[32px] font-medium'>18</h3>
                                    <p className='text-second-color text-[16px] font-semibold'>Related Spots</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="xl:col-span-7 lg:col-span-6 col-span-12 lg:mt-0 mt-12">
