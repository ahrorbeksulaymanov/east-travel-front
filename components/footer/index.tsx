    ...
    return (
        <footer className="font-montserrat md:pt-[147px] pt-[34px] md:pb-[40px] pb-[54px] text-[#5E6282] relative">
            <div className="container mx-auto relative z-[3]">
                ...
                <p className="md:mt-[86px] mt-[30px] text-center relative z-[3] text-[#000] font-medium">All rights reserved <a target="_blank" className="text-[] underline" href="https://t.me/sulaymanov_a">ahror</a></p>
            </div>
